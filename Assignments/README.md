# 📅 Spatial Data Course — Notebook Checklist

Base directory: `/Users/griffin/__currentCourses/4543-5993-Spatial-Data/`

**Totals at a glance**

- `01-Python_Foundations`: **38** notebooks (Only 40%-50% need be completed)
- `02-Missile_Geometry_101`: **11** notebooks (Either this version with a working project OR )
- `02-Missile_Geometry_202`: **60** notebooks (This version complete all notebooks)
- `03-Data_Manager`: **21** notebooks (Complete All Notebooks)
- **Grand total: 130**
